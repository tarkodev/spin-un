...
exports.verificationInstancePlayer = exports.swapDrawStackAndCardDeposit = void 0;
...
function checkInformationStatus(information, cardDeposit, drawStack, p) {
    ...
    switch (information) {
        ...
        case player_1.noCardCanBePlayed:
            ...
            break;
        /* +2 actif sur le dépot */
        case player_1.youNeedToDrawTwoCards:
            /* Désactiver le dépot */
            cardDeposit[0].effectToApply = false;
            /* Piocher 2 cartes */
        ...
        switch (userInputChoice) {
            case "j":
                ...
                do {
                    ...
                    countAction++;
                } while (returnOfAction === false && countAction < 3);
                if (countAction === 3) {
                    drawInDrawStack(cardDeposit, drawStack, p);
                }
